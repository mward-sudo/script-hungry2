import { iHomePageHero, iHomePageHeroes } from '@/types/graphcms-api'
 ...
 */
export const getHomePageHero = async (): Promise<iHomePageHero> => {
  ...
  if (narrowType<iHomePageHeroes>(response))
